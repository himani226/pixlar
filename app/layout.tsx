...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Pixlar:  Media tools designed for speed and simplicity.',
    template: '%s | Pixlar',
  },
  description:
  ...
  keywords: [
    'image compressor', 'compress image online free', 'crop image online',
    'resize image', 'background remover', 'image format converter',
    'compress video online free', 'trim video', 'convert video format',
    'free online photo editor', 'private image tools',
  ],
  authors: [{ name: 'Pixlar' }],
  creator: 'Pixlar',
  openGraph: {
