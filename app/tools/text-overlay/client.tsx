...
export default function TextOverlayClient() {
  ...
  // 0 = auto-fit to text, >0 = manual override in image pixels
  ...
  const renderCanvas = useCallback(() => {
    ...
    if (bgEnabled && bgOpacity > 0) {
      ...
      // Use manual size if set, otherwise auto-fit to text
      ...
      {imageSrc && (
        <div style={{ marginTop: 24 }}>
          ...
          <div style={{ marginBottom: 16 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
              <label style={{ fontSize: 13, color: 'var(--text-2)' }}>
                Text lines &mdash; each block = one line on the image
              </label>
            ...
            {blocks.map((block, idx) => (
              <div key={block.id} style={{ display: 'flex', gap: 8, marginBottom: 8, alignItems: 'center' }}>
                ...
                <input type="text" value={block.text}
                  ...
                  placeholder={`Line ${idx + 1}...`} style={{ flex: 1, fontSize: 15 }} />
                {blocks.length > 1 && (
            ...
            <p style={{ fontSize: 12, color: 'var(--text-3)', marginTop: 4 }}>
              Tip: each input = one new line. Add as many as needed.
            </p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12, marginBottom: 16 }}>
            <div>
              <label style={{ fontSize: 13, color: 'var(--text-2)', display: 'block', marginBottom: 6 }}>Text colour</label>
          ...
          <div className="card" style={{
            ...
            {/* Toggle header */}
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: bgEnabled ? 16 : 0 }}>
              <div>
                <p style={{ fontSize: 14, fontWeight: 500 }}>Background box</p>
                <p style={{ fontSize: 12, color: 'var(--text-3)', marginTop: 2 }}>
                  Coloured box behind text &mdash; for medical forms, IDs, certificates
                </p>
              </div>
              {/* Toggle switch */}
            ...
            {bgEnabled && (
              <>
                {/* Row 1: colour + opacity + padding */}
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px,1fr))', gap: 12, marginBottom: 12 }}>
                  <div>
                    <label style={{ fontSize: 13, color: 'var(--text-2)', display: 'block', marginBottom: 6 }}>BG colour</label>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                ...
                <div style={{
                  ...
                  <div>
                    <label style={{ fontSize: 13, color: 'var(--text-2)', display: 'block', marginBottom: 6 }}>
                      Box width &mdash; {bgWidth === 0 ? 'Auto (fits text)' : `${bgWidth}px`}
                    </label>
                    {/* Slider: 0 = auto, up to image natural width */}
                  ...
                  <div>
                    <label style={{ fontSize: 13, color: 'var(--text-2)', display: 'block', marginBottom: 6 }}>
                      Box height &mdash; {bgHeight === 0 ? 'Auto (fits text)' : `${bgHeight}px`}
                    </label>
                ...
                <p style={{ fontSize: 11, color: 'var(--text-3)', marginTop: 8 }}>
                  Sizes are in image pixels. Set to 0 to auto-fit around text. Type exact value or use the slider.
                </p>
              </>
            )}
          </div>
